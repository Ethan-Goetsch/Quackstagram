...
public class ImageUploadUI extends QuackstagramUI
{
    ...
    public ImageUploadUI(int width, int height, int navIconSize, IAction<PageType> onNavigationCallback)
    {
        super(width, height, navIconSize, "Upload Image", onNavigationCallback);
        initializeUI();
    }
